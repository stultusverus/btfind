...
Search uses SQLite FTS5 (trigram tokenizer) over torrent names and file paths. Results are ranked by relevance for non-empty queries.
...
GET /api/search?q=ubuntu      Search torrents (FTS5, ranked)
